...
> Board: ASRock AMD BC-250 | Codename: "Ariel" / "Cyan Skillfish"
> Mining board repurposed as a budget gaming/desktop PC.
...
| **CPU** | 6× Zen 2 cores, ~3.5 GHz fixed base clock |
| **GPU** | 24× RDNA 2 Compute Units (CUs), codename gfx1013 |
...
| Length | ~340 mm (varies by measurement) |
| Width | ~115 mm |
...
| M.2 2280 Slot | 1 | PCIe 2.0 ×2 NVMe **or** SATA III |
| PCIe 8-pin (6+2) | 1 | Main power connector |
| Fan Headers | 2× 4-pin PWM | J1 (primary) and J4003 (secondary) |
| Power Button | Onboard only | No header — solder for external switch |
| TPM Header | 1 | No TPM chip included |
...
| Maximum (Furmark + CPU stress) | ~340 W | AIO cooling recommended |
