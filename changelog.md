...
- Cyberpunk CPU-bound: hecto_77113 (09/07/2026). Hogwarts ~60 @ 1080p Medium: nexgen3d (26/12/2025, benchmark thread). RDR2 2230/2150: i_guess_im_a_girl (20/11/2025). Elden Ring 45–50 (was 45–51, corrected to quote): mzk10 (06/11/2025). Borderlands 3 default ~60: selectivelygood_16010 (27/11/2025). Borderlands 3 Eden-6 ~62: whomstdv (26/11/2025). Borderlands 3 68→82 OC @2GHz: .warlocksyno (25/05/2026). Starfield section: vvaaron (08/12/2025, 06/01/2026). Genshin 60 locked/65–68C: daniifreitas (08/12/2025). Arc Raiders: maty99 (26/03/2026). Ghost of Tsushima: dryadalis5392 (13/12/2025) + sinh_28065 (12/02/2026, v1053.0718+ no crash). AC IV TAA native 45–50/60+: g_sh0ck. (15/07/2026). Forza H5 40→100: ungamead (21/02/2026); 1440p TAA 50–60: antmagl (16/05/2026). Helldivers 2 40–60: eurobirb (27/11/2025). Valheim 100% mitigations boost: imeden (05/12/2025). GTA V Enhanced Mesa 26 fix: soulnull (14/02/2026); 1440p FSR3 65C: fontanedo (29/05/2026). Oblivion Remaster 30–75 @3440x1440: gennro (28/03/2026). Marvel Rivals 190→100: jainator (10/05/2026). Horizon FW low GPU usage: _titotito (08/06/2026). Callisto 60–85: nexgen3d (04/12/2025). ZZZ memory shortage: pm_me_kitsunemimi (31/03/2026). Palia swapfile: dillydilly_91 (23/02/2026). Warframe 120@1440p: discombobulateddunce (04/06/2026). Diablo IV 1440 FSR: bobafettm (16/02/2026). RE9 settings credit restored to dbkretro + REFramework FG crash: .strykur (25/05/2026). FF7 512MB crash: lonewolf05849 (11/01/2026). GameScope artifacts: i.am.brantastic + safwyl (13/05/2026). Manjaro "just booted fine": samuelwf4949 (28/06/2025).

### Flagged (attribution pending — legacy, source not recorded)
- Cyberpunk "<60 even at lowest" (hecto_77113 quote covers dips to 50/40, but the "<60 at lowest settings" figure is from a separate claim — source not located). Tsushima "45–60 @ 1080p Low, 1.7–1.9 GHz GPU OC" (no export found).

### Removed from docs (unverifiable)
- Manjaro kernel recommendation (`linux618`/`linux619` via mhwd-kernel) — generic editorial recommendation with no recoverable source attribution; removed from doc 05 Manjaro section (DOC_STANDARDS §3).
