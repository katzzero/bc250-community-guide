...
> **Comprehensive, community-driven guide for the ASRock AMD BC-250 mining board repurposed as a budget gaming/desktop PC.**
...
| **CPU** | 6× Zen 2 cores @ ~3.5 GHz |
| **GPU** | 24 RDNA 2 CUs, base 1500 MHz, up to 2230 MHz (OC) |
| **Memory** | 16 GB GDDR6 shared (CPU + GPU) |
| **Storage** | 1× M.2 2280 (PCIe 2.0 ×2 NVMe or SATA3) |
| **TDP** | 220W (up to 235W under full load) |
| **Display** | 1× DisplayPort 1.4 (no HDMI — adapter required) |
| **Network** | 1× Gigabit Ethernet (no built-in WiFi) |
...
| PSU (Best Value) | FSP500-30AS Flex ATX 500W, **80+ Platinum** | eBay — search `389522369783` |
| Fan | Arctic P12 Pro 120mm (3-pack or 5-pack) | Amazon |
| Thermal Pad (APU) | PTM7950 Phase Change Pad | Amazon B0DHRR78H7 |
| Thermal Pads | 1.5 mm front, 2.0 mm back | Amazon multi-pack |
| Display Cable | Passive DP-to-HDMI | Amazon / AliExpress ~$2 |
| WiFi | TP-Link Archer TX10UB Nano (WiFi 6 + BT 5.3) | Amazon B0DZCC95G6 |
